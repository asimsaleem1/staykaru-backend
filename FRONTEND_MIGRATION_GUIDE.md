...
```javascript
// CORRECT URL with /api suffix
const BASE_URL = 'https://api.staykaru.tech/api';

// INCORRECT URL
// const BASE_URL = 'https://api.staykaru.tech'; // Missing /api
```

The error "Cannot POST /api/auth/register" usually means the URL is incorrect or there's a connectivity issue.
