...
export class LocationController {
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve a list of all countries in the database. Returns countries with their IDs and names.'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Update an existing country\'s information. Only provide fields that need to be updated.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({ 
    ...
    description: 'Delete a country from the database. Cannot delete countries that have cities associated with them.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({ 
    ...
    description: 'Add a new city to the location database. The city must be associated with an existing country. Includes geographic coordinates for location-based services.'
  })
  @ApiResponse({ 
    status: 201, 
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve a list of all cities in the database. Each city includes its country information and geographic coordinates.'
  })
  @ApiQuery({
    name: 'country',
  ...
  @ApiOperation({ 
    ...
    description: 'Find cities within a specified radius of given coordinates. Useful for location-based accommodation and food service searches.'
  })
  @ApiQuery({
    name: 'longitude',
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve a specific city by its MongoDB ObjectId. Includes country information and geographic coordinates.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve all cities that belong to a specific country. Useful for populating location dropdowns or filtering accommodations by region.'
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ObjectId of the country',
  ...
  @ApiOperation({ 
    ...
    description: 'Update an existing city\'s information. Only provide fields that need to be updated. If changing the country, ensure the new country exists.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({ 
    ...
    description: 'Delete a city from the database. This will remove all accommodations and related data in this city.'
  })
  @ApiParam({
    name: 'id',
