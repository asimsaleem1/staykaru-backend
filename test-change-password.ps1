...
Write-Host "=== StayKaru Change Password Test ===" -ForegroundColor Yellow
...
try {
    ...
    Write-Host "Password is back to original: Sarim786" -ForegroundColor Green
} catch {
    Write-Host "❌ Password revert failed: $($_.Exception.Message)" -ForegroundColor Red
}
